        ...
        <section className='subtract'>
            ...
            <div className='subtract__card'>
                {showScore ? (
                    ...
                    <>
                        {questions[currentQuestion].id === 1 ? <><img src={BunnyRight} alt="Flying pup called Skye" className="subtract__pic subtract__pic--one" /></>: questions[currentQuestion].id === 2 ? <><img src={BunnyRight} alt="Flying pup called Skye" className="subtract__pic subtract__pic--two" /></>: questions[currentQuestion].id === 3 ? <><img src={BunnyLeft} alt="Flying pup called Skye" className="subtract__pic subtract__pic--three" /></>: questions[currentQuestion].id === 4 ? <><img src={BunnyRight} alt="Flying pup called Skye" className="subtract__pic subtract__pic--four" /></>: questions[currentQuestion].id === 5 ? <><img src={BunnyLeft} alt="Flying pup called Skye" className="subtract__pic subtract__pic--five" /></>: questions[currentQuestion].id === 6 ? <><img src={BunnyRight} alt="Flying pup called Skye" className="subtract__pic subtract__pic--six" /></>: questions[currentQuestion].id === 7 ? <><img src={BunnyLeft} alt="Flying pup called Skye" className="subtract__pic subtract__pic--seven" /></>: questions[currentQuestion].id === 8 ? <><img src={BunnyRight} alt="Flying pup called Skye" className="subtract__pic subtract__pic--eight" /></>: questions[currentQuestion].id === 9 ? <><img src={BunnyLeft} alt="Flying pup called Skye" className="subtract__pic subtract__pic--nine" /></>: questions[currentQuestion].id === 10 ? <><img src={FlippyStraight} alt="Sitting pup called Skye" className="subtract__pic subtract__pic--ten" /></>: null}
